...
export default function StoreProducts({
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="flex gap-3 mb-6 overflow-x-auto pb-2 w-full hide-scrollbar">
      ...
      {filteredCategories.map((category) => (
        ...
        >
          ...
          <div className="flex gap-6 overflow-x-auto md:flex-wrap md:overflow-x-visible hide-scrollbar md:overflow-visible snap-x snap-mandatory">
            {sortProductsByStock(
              ...
              <div
                key={product.id}
                className="flex-shrink-0 md:flex-shrink snap-center"
              >
